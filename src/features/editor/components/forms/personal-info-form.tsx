...
import {
  PERSONAL_INFO_FORM_DESCRIPTION,
...
import {
  ...
  personalInfoSchema,
} from "@/features/editor/schemas/personal-info.schema"
...
export function PersonalInfoForm({
  ...
  return (
    <FormWrapper
      title={PERSONAL_INFO_FORM_TITLE}
      description={PERSONAL_INFO_FORM_DESCRIPTION}
    >
      <Form {...form}>
